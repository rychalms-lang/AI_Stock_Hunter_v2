...
export type OpenPosition = {
  ...
  sector: string;
  status: string;
  origin?: "scanner_automatic" | "user_directed" | string;
  opened_at: string;
  entry_date: string;
  entry_price: number;
  ...
  automatic_paper_eligibility?: string;
  automatic_paper_eligibility_reason?: string;
  paper_execution?: string;
  user_selected_allocation_pct?: number;
